 ...
 * Uses etic_snapshots — not mel_snapshot alone — so the MEL trend chart and
 * date picker stay aligned even when MEL ingest/rebuild missed days or is mid-repair.
 */
